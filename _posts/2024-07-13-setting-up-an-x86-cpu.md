...
the [nasm tutorial by Ray Toal](https://cs.lmu.edu/~ray/notes/nasmtutorial/)
for getting started.
...
<img src="{{ '/public/figures/x86-mode-transitions.png' | absolute_path }}" alt="Overview of x86 mode transitions" class="screenshot">
...
amount of stuff in 512 bytes](https://github.com/jart/sectorlisp),
...
<img src="{{ '/public/figures/qemu-hello-world-screenshot.png' | absolute_path }}" alt="QEMU screenshot of the hello world message" class="screenshot" />
...
[osdev.org page](https://wiki.osdev.org/Disk_access_using_the_BIOS_(INT_13h))
on this.
...
<img src="{{ '/public/figures/qemu-hello-stage2-screenshot.png' | absolute_path }}" alt="QEMU screenshot of the stage 2 message" class="screenshot" />
...
<img src="{{ '/public/figures/segment-descriptor-layout.png' | absolute_path }}" alt="Screenshot of segment descriptor layout" class="screenshot" />
...
[Introduction to Paging](https://os.phil-opp.com/paging-introduction/) from
the "Writing an OS in Rust" blog was really useful for me personally.
[OSTEP](https://pages.cs.wisc.edu/~remzi/OSTEP/) also talks about paging
...
<img src="{{ '/public/figures/qemu-comp-mode-screenshot.png' | absolute_path }}" alt="QEMU screenshot of the success message" class="screenshot">
...
<img src="{{ '/public/figures/qemu-c-screenshot.png' | absolute_path }}" alt="QEMU screenshot of the message printed by C code" class="screenshot">
